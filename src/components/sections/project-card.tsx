  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(400px circle at var(--mx,50%) var(--my,50%), rgba(139,92,246,0.12), transparent 60%)",
        }}
      />
      ...
      <div
        className={cn(
          "relative mb-6 aspect-[16/10] overflow-hidden rounded-xl border border-border bg-gradient-to-br",
          project.accent
        )}
      >
